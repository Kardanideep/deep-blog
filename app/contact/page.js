    ...
    <section className="body-font relative">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Feel free to reach out with any questions, feedback, or inquiries. We're here to help!</p>
        </div>
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <form onSubmit={handleSubmit} className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <Button
                type="submit"
                variant="outline" 
                className="flex mx-auto focus:outline-none rounded text-lg"
              >
                Send Message
              </Button>
            </div>
          ...
          <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
            <a href="mailto:example@email.com" className="text-indigo-500">kardanideep1@email.com</a>
            <p className="leading-normal my-5">Rajkot<br />Gujarat, India</p>
